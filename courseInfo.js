function courseInfo(){
    /*
        ...
        https://loris.wlu.ca/ssb_prod/bwckctlg.p_disp_course_detail?cat_term_in=201805&subj_code_in=CP&crse_numb_in=104
    */
    //login
...
var curr = "https://loris.wlu.ca/ssb_prod/bwckctlg.p_disp_course_detail?cat_term_in=";
if (link.includes(curr)){
    courseInfo();
}*/
    courseInfo();